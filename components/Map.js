...
const SLOW_STREETS_POLYGON_URL =
  'https://services.arcgis.com/sFnw0xNflSi8J0uh/arcgis/rest/services/fy20_neighborhood_slow_streets/FeatureServer/0';
...
class Map extends React.Component {
  ...
  componentDidMount() {
    ...
    this.map.on('load', () => {
      ...
      this.map.addSource('slowStreetsAreas-polygon', {
        type: 'geojson',
        data: `${SLOW_STREETS_POLYGON_URL}/query?where=1%3D1&outFields=*&outSR=4326&returnExceededLimitFeatures=true&f=pgeojson`,
      });

      // this.map.addLayer({
      //   id: 'slowStreetsAreas',
      //   type: 'fill',
      //   source: 'slowStreetsAreas-polygon',
      //   paint: {
      //     'fill-color': 'grey',
